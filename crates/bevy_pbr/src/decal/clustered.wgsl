...
fn get_view_z(world_position: vec3<f32>) -> f32 {
    return dot(vec4<f32>(
        mesh_view_bindings::get_view().view_from_world[0].z,
        mesh_view_bindings::get_view().view_from_world[1].z,
        mesh_view_bindings::get_view().view_from_world[2].z,
        mesh_view_bindings::get_view().view_from_world[3].z
...
fn view_is_orthographic() -> bool {
    return mesh_view_bindings::get_view().clip_from_view[3].w == 1.0;
}
